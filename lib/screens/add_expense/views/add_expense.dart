...
import 'package:personal_budget/screens/add_expense/blocs/create_expense_bloc/create_expense_bloc.dart';
import 'package:personal_budget/screens/add_expense/blocs/get_categories_bloc/get_categories_bloc.dart';
import 'package:personal_budget/screens/add_expense/views/category_creation.dart';
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<GetCategoriesBloc, GetCategoriesState>(
            builder: (context, state) {
              if (state is GetCategoriesSuscces) {
                return Padding(
